...
public class App extends JFrame {
    ...
    public App() {
        ...
        pesanButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                tampilkanInvoice(kode, jam, jumlahTiket, harga, totalHarga);
            }
        });
        constraints.gridx = 0;
        constraints.gridy = 3;
    ...
    private void tampilkanInvoice(String kode, String jam, int jumlahTiket, int harga, int totalHarga) {
